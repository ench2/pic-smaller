...
const localeData: LocaleData = {
  logo: brand.zhCN,
  siteTitle: getSeoCopy("zh-CN").pageTitle,
  siteDescription: getSeoCopy("zh-CN").summary,
  initial: "初始化中",
  previewHelp: "拖动分割线对比压缩效果：左边是原始图，右边是压缩图",
  heif: {
    previewUnavailable:
      "浏览器无法直接显示 HEIC/HEIF 原图，因此暂不支持压缩前后对比。",
    originalPreserved:
      "未指定输出格式，已保留 HEIC/HEIF 原文件；如需缩放或压缩，请选择输出格式。",
  },
  errors: {
  ...
  uploadCard: {
    title: "选择图片",
    subTitle: "支持 %s，拖入图片或文件夹即可开始",
    pasteHint: "也可以按 Ctrl+V / ⌘V 粘贴图片",
  },
  listAction: {
    batchAppend: "批量添加",
    addFolder: "添加文件夹",
  ...
  optionPannel: {
    ...
    help: `${brand.zhCN}是一款批量图片压缩应用程序，对选项的修改将应用到所有图片上`,
    resizeLable: "调整图片尺寸",
